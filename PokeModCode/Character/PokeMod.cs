...
public class PokeMod : PlaceholderCharacterModel
{
    ...
    public override CardPoolModel CardPool => ModelDb.CardPool<PokeModCardPool>();
    public override RelicPoolModel RelicPool => ModelDb.RelicPool<PokeModRelicPool>();
    public override PotionPoolModel PotionPool => ModelDb.PotionPool<PokeModPotionPool>();
