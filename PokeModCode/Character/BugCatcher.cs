...
using PokeMod.PokeModCode.Relics;

namespace PokeMod.PokeModCode.Character;



public class BugCatcher : PlaceholderCharacterModel
{
    ...
    public override IEnumerable<CardModel> StartingDeck => [
        ModelDb.Card<StrikeBugCatcher>(),
        ModelDb.Card<StrikeBugCatcher>(),
        ModelDb.Card<StrikeBugCatcher>(),
        ModelDb.Card<StrikeBugCatcher>(),
        ModelDb.Card<DefendBugCatcher>(),
        ModelDb.Card<DefendBugCatcher>(),
        ModelDb.Card<DefendBugCatcher>(),
        ModelDb.Card<DefendBugCatcher>(),
        ModelDb.Card<Wurmple>(),
        ModelDb.Card<Harden>(),
    ];

    public override IReadOnlyList<RelicModel> StartingRelics =>
    [
        ModelDb.Relic<Pokedex>(),
        //ModelDb.Relic<BugCatchersNet>()
    ];
    
    public override CardPoolModel CardPool => ModelDb.CardPool<BugCatcherCardPool>();
    public override RelicPoolModel RelicPool => ModelDb.RelicPool<BugCatcherRelicPool>();
    public override PotionPoolModel PotionPool => ModelDb.PotionPool<BugCatcherPotionPool>();
    
    /*/*  PlaceholderCharacterModel will utilize placeholder basegame assets for most of your character assets until you
        override all the other methods that define those assets. 
        These are just some of the simplest assets, given some placeholders to differentiate your character with. 
        You don't have to, but you're suggested to rename these images. #1#
